...
import org.fengluo.api.ApiGoogle;
...
public class Main {
    ...
    public static Long SLEEP_TIME = 100L;
    public static ObjectMapper mapper = new ObjectMapper();
    /**
     * 三个参数分别是用户id、用户密钥、翻译间隔
     */
    private static String APP_ID = "20210717000890399";
    private static String SECURITY_KEY = "n8hHL4JWLfBgRYf9Fl0z";
    ...
    public static void main(String[] args) throws IOException, NoSuchAlgorithmException, InterruptedException {
        ...
        if (map.get("file") != null) {
            ...
            if (map.get("file").endsWith(".json")) {
                TranslationJSON.getInstance(new ApiGoogle()).translation(map.get("file"));
            } else if (map.get("file").endsWith(".lang")) {
                TranslationLang.getInstance(new ApiGoogle()).translation(map.get("file"));
            }
        } else {
